...
export default function MatchSelector({ setMatchData, allMatches, allData, league, date }: MatchSelectorProps) {
  ...
  return (
    <div className="flex flex-col items-center justify-center">
      <h1 className={`text-3xl font-bold mb-16 text-[#FFD700] ${
      ...
      <div className="w-full relative">
              ...
              >
                ...
                >
                  <div className="flex text-yellow-100 relative z-10 text-white uppercase text-sm">
                    ...
                    <span className="w-48 h-6 m-0.5 flex flex-col justify-end">{formatLocation(location)}</span>
                    </div>
        ...
        <button
          ...
          className={`leftArrowBtn -mt-4 top-1/2 transform -translate-y-1/2 p-2 ${
        ...
        <button
          onClick={handleNext}
          className={`rightArrowBtn -mt-4 top-1/2 transform -translate-y-1/2 p-2 ${
            allMatches.length != 0 && date.length == 10 ? '' : 'hidden'
          }`}
