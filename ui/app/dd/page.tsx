...
function App() {
  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        <h2 className="text-xl font-bold mb-4">Selected Names ({selectedNames.length}/4)</h2>
        ...
        {currentData.names.map((name, index) => (
          <button
            ...
            className={`p-2 rounded ${
              isNameSelected(name) ? "bg-blue-500 text-white" : "bg-gray-100 hover:bg-gray-200"
            } ${selectedNames.length >= 4 && !isNameSelected(name) ? "opacity-50 cursor-not-allowed" : ""}`}
