...
match_data_path = '/Users/ved14/Library/CloudStorage/GoogleDrive-v_umrajkar@ma.iitr.ac.in/My Drive/SEM7/extras/dream11-inter-iit/data/player_match_data_2010_onwards.json'
aggregate_data_path = '/Users/ved14/Library/CloudStorage/GoogleDrive-v_umrajkar@ma.iitr.ac.in/My Drive/SEM7/extras/dream11-inter-iit/data/aggregate_cricket_stats_t20.json'
...
for player, matches in tqdm(player_data.items()):
    ...
    for match_id, stats in matches.items():
        ...
        if match_id[-3:] == "T20":
            ...
            extended_stats = {
                ...
                **player_aggregate_stats  # This unpacks all aggregate stats at the same level
            }
...
output_path = '/Users/ved14/Library/CloudStorage/GoogleDrive-v_umrajkar@ma.iitr.ac.in/My Drive/SEM7/extras/dream11-inter-iit/player_fantasy_points_t20.json'
