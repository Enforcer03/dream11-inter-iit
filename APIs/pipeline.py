...
if __name__ == "__main__":
    ...
    player_info = {
        "Nottinghamshire": [
            "BT Slater : Nottinghamshire",
            "FW McCann : Nottinghamshire",
            "JA Haynes : Nottinghamshire",
            "H Hameed : Nottinghamshire",
            "LW James : Nottinghamshire",
            "TJ Moores : Nottinghamshire",
            "LA Patterson-White : Nottinghamshire",
            "CG Harrison : Nottinghamshire",
            "BA Hutton : Nottinghamshire",
            "R Lord : Nottinghamshire",
            "LJ Fletcher : Nottinghamshire",
            "OJ Price : Nottinghamshire",
        ],
        "Gloucestershire": [
            "James Bracey : Gloucestershire",
            "GL van Buuren : Gloucestershire",
            "AS Dale : Gloucestershire",
            "CT Bancroft : Gloucestershire",
            "Zaman Akhter : Gloucestershire",
            "OJ Price : Gloucestershire",
            "JMR Taylor : Gloucestershire",
            "TMJ Smith : Gloucestershire",
            "DC Goodman : Gloucestershire",
    ...
    consistency_score, diversity_score, form_score = evaluate_team(
        selected_players, stats_df, cov_matrix
    )
